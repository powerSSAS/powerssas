...
!define PRODUCT_VERSION "0.3.1.3"

!define PRODUCT_NAME "powerSSAS 2008"
!define PRODUCT_PUBLISHER "powerSSAS"
!define PRODUCT_WEB_SITE "http://www.codeplex.com/powerSSAS"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Installer for ${PRODUCT_NAME}"
...
#$opt3_state = ${BST_CHECKED}
	...
	${NSD_CreateRadioButton} 0 40u 100% 10u "Install as Snap-in (PowerShell v1 compatible)"
  	        Pop $opt1
        ${NSD_CreateRadioButton} 0 55u 100% 10u "Install as Module (PowerShell v2) - for current user only"
                Pop $opt2
        ${NSD_CreateRadioButton} 0 70u 100% 10u "Install as Module (PowerShell v2) - for everyone [Recommended]"
                Pop $opt3
${NSD_SetState} $opt3 ${BST_CHECKED}
...
Function nsDialogsPageLeave
        ${NSD_GetState} $opt1 $opt1_State
        ${NSD_GetState} $opt2 $opt2_State
        ${NSD_GetState} $opt3 $opt3_State
FunctionEnd
