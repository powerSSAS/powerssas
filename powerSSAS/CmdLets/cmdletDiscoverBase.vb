...
Namespace Cmdlets
    ...
    Public MustInherit Class CmdletDiscoverBase
        ...
        <Parameter(HelpMessage:="Xmla Restrictions", Mandatory:=False, Position:=2, ValueFromPipeline:=True)> _
        ...
        <Parameter(HelpMessage:="Xmla Properties", Mandatory:=False, Position:=3, ValueFromPipeline:=True)> _
        ...
        <Parameter(HelpMessage:="Analysis Services server name", Mandatory:=False, ParameterSetName:="ServerName", Position:=1, ValueFromPipeline:=True)> _
        ...
        Protected Overrides Sub ProcessRecord()
            ...
            WriteObject(xd.Discover(DiscoverRowset, ServerName, XmlaRestrictions, XmlaProperties))
        End Sub
